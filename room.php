<?php
session_start(); // optional if using session
require_once "dbaseconnection.php"; // assumes connection is set up

// You can include common layout using include() or keep this as a full standalone page like your reservations file
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- Copy your navbar here or include it as a file -->
